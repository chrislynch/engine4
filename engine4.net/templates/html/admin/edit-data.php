...
<form action="?e4_action=admin&e4_op=save&e4_ID=<?php print $content['ID']; ?>" method="POST">
	...
	<table>
		...
		<tr><td>Body</td><td><textarea name="e4_form_content_data_body" cols="40" rows="60"><?=@$content['data']['body'];?></textarea></td></tr>
	
		<tr><td><h3>SEO Data</h3></td><td></td></tr>
		...
		<tr><td><h3>Save</h3></td><td><input name="save" type="submit"></td></tr>			
	</table>
</form>
<?php }?>