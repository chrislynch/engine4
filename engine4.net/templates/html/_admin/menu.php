...
<div class="span-24 last" id="MenuContainer">
	<div id="MainMenu">
		<ul id="MainMenuList">
			...
			<li><a href="#" class="MenuTab" id="eCommerceMenuItem">eCommerce</a></li>
...
-->	
  <div id="ContentMenuContent" class="MenuContent">
	...
	<div id="eCommerceMenuContent" class="MenuContent">
		<ul>
			<li><a href="@@configuration.basedir@@?e4_action=admin&e4_admin_op=search&e4_adminType=order">View Orders</a></li>
		</ul>
	</div>
      <div id="UsersMenuContent" class="MenuContent">
		...
		<ul>
			<li><a href="@@configuration.basedir@@?e4_action=admin&e4_admin_op=create&e4_adminType=user&e4_adminTypeIsContent=0">Create New User</a></li>
			<li><a href="@@configuration.basedir@@?e4_action=admin&e4_admin_op=search&e4_adminType=user">Find User</a></li>
		</ul>
	</div>
