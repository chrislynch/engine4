    <div id="home-text" class="span-14 last">
...
<div id="sidebar-right" class="home span-6 last">
    <div class="sidebar-heading">Latest News</div>
    <div class="sidebar-item">
        <ul>
            <li>sundaymarketplace.com wins "Welsh Technology Business" prize</li>
            <li>We're hiring ... sundaymarketplace.com brings jobs to South East Wales</li>
        </ul>
    </div>
    ...
    }).render().setUser('chrislynch_mwm').start();
    </script>
</div>