...
function e4_renderer_html_html_go($templates){
	...
	ob_start();
        ...
        if (e4_renderer_html_html_pageHasErrors($data)){
            include e4_findtemplate('messages.php');
            include e4_findtemplate('body-end.php');
            include e4_findtemplate('footer.php');
        } else {
            include e4_findtemplate('messages.php');
            include e4_findtemplate($viewtype . '-begin.php');
            ...
            include e4_findtemplate($viewtype . '-end.php');
            include e4_findtemplate('body-end.php');
            include e4_findtemplate('footer.php');
        }
...
function e4_renderer_html_html_pageHasErrors($data){
    $return = FALSE;
